...
class LoginView(Common):
    ...
    code_login=(By.ID, 'com.tal.kaoyan:id/login_code_touname')
    ...
    def login_action(self,username,password):
        ...
        self.driver.find_element(*self.code_login).click()
        ...
        self.driver.find_element_by_id("com.tal.kaoyan:id/login_treaty_checkbox_password").click()
...
if __name__ == '__main__':
    ...
    l=LoginView(driver)
    l.login_action('18817936080','zxc12345')
